...
Data..: 23/06/2025
Enunciado:
    (desafio 1): Idem ao EX03, todavia, valide a data de acordo com o calendário gregoriano 

    Regra de validação: o ano é constituído por 12 meses que podem ter entre 28 a 31 dias. Um ano pode ter 365 ou 366 dias, chamado neste caso de ano bissexto. Não aceitar datas posteriores ao dia DE HOJE. 
*/
