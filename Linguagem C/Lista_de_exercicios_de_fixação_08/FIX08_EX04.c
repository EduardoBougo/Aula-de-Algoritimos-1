...
void addition(void){
    ...
    for(i = 0; i < rep; i++){
        printf("Digite o %d° valor (0 para a execução): ", (i +));
        scanf("%f", &num);
        sum += num;
    }

    printf("A soma é igual a >>> %.2f <<<", sum);
}
...
void subtraction(void){
    ...
    for(i = 0; i < rep; i++){
        printf("Digite um valor (0 para a execução): ");
        scanf("%f", &num);
        sub -= num;
    }

    printf("A subtração é igual a >>> %.2f <<<", sub);
}
...
void multiplication(void){
    ...
    printf("A multiplicação é igual a >>> %.2f <<<", mult);
}
...
void division(void){
    ...
    printf("A divisão é igual a >>> %.2f <<<", div);
}
